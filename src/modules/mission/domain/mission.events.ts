// ============================================================================
// MISSION DOMAIN EVENTS - DOMAIN LAYER
// ============================================================================
// Événements émis par le domain pour intégration future (Payment, Notification)
// Ces événements peuvent être consommés par d'autres modules
// ============================================================================
...
export interface CancellationApprovedEvent {
  ...
  payload: {
    missionId: string;
    status: string;
    // NOTE: Le module Payment sera notifié pour remboursement
    updatedAt: Date;
  };
}
...
export type MissionEvent = 
  | MissionCreatedEvent
  | InitialPaymentConfirmedEvent
  | MissionAcceptedEvent
  | MissionRefusedEvent
  | NegotiationFinalizedEvent
  | FinalPaymentConfirmedEvent
