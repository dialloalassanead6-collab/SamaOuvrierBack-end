...
import { Mission, MissionStatus, type CreateMissionInput, type MissionResponse } from '../domain/index.js';
...
export class CreateMissionUseCase {
   ...
   */
  async execute(input: CreateMissionInput, authenticatedUserId: string): Promise<MissionResponse> {
   ...
   */
  private validateInput(input: CreateMissionInput): void {
