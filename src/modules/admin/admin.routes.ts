...
router.get(
  ...
  pagination(),
  asyncHandler(adminController.listWorkers.bind(adminController))
);
...
router.patch(
  ...
  authenticate(),
  authorize(Role.ADMIN),
  asyncHandler(adminController.approveWorker.bind(adminController))
);
...
router.patch(
  ...
  authenticate(),
  authorize(Role.ADMIN),
  asyncHandler(adminController.rejectWorker.bind(adminController))
);
...
router.delete(
  ...
  authenticate(),
  authorize(Role.ADMIN),
  asyncHandler(adminController.softDeleteUser.bind(adminController))
);
...
router.patch(
  ...
  authenticate(),
  authorize(Role.ADMIN),
  asyncHandler(adminController.restoreUser.bind(adminController))
);
