...
router.post(
  '/',
  authenticate,
  disputeController.getUploadMiddleware(),
...
router.get(
  '/',
  authenticate,
  (req, res) => disputeController.getDisputes(req, res)
);
...
router.get(
  '/my',
  authenticate,
  (req, res) => disputeController.getMyDisputes(req, res)
);
...
router.get(
  '/:id',
  authenticate,
  (req, res) => disputeController.getDisputeById(req, res)
);
...
router.post(
  ...
  authenticate,
  disputeController.getUploadMiddleware(),
  (req, res) => disputeController.addEvidence(req, res)
);
...
router.delete(
  ...
  authenticate,
  (req, res) => disputeController.deleteEvidence(req, res)
);
...
router.patch(
  ...
  (req, res) => disputeController.reviewDispute(req, res)
);
...
router.patch(
  ...
  authenticate,
  authorize(Role.ADMIN),
  (req, res) => disputeController.resolveDispute(req, res)
);
