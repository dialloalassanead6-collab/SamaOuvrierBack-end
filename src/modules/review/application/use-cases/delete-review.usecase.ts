...
export class DeleteReviewUseCase {
  ...
  async execute(dto: DeleteReviewDTO): Promise<DeleteReviewResult> {
    ...
    try {
      ...
      const result = await this.reviewRepository.transaction(async () => {
        ...
        if (!review) {
          return { success: false, error: 'Review not found' } as DeleteReviewResult;
        }
        ...
        return { success: true } as DeleteReviewResult;
      });
