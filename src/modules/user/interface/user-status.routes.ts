...
class UserStatusController {
  ...
  private toggleOwnActivationUseCase: ToggleOwnActivationUseCase;
  private toggleUserBanUseCase: ToggleUserBanUseCase;
   ...
   */
  async toggleUserActivation(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
   ...
   */
  async toggleOwnActivation(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
   ...
   * PATCH /users/:id/ban
   */
  async toggleUserBan(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
      const userId = req.params.id as string;
      const { action } = req.body;
...
router.patch(
  '/me/activation',
  authenticate(),
  asyncHandler(userStatusController.toggleOwnActivation.bind(userStatusController))
);
...
router.patch(
  ...
  asyncHandler(userStatusController.toggleUserActivation.bind(userStatusController))
);
...
router.patch(
  ...
  authenticate(),
  authorize(Role.ADMIN),
  asyncHandler(userStatusController.toggleUserBan.bind(userStatusController))
);
