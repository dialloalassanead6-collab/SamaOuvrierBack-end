...
export class UserBannedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_IS_BANNED) {
    super({
      message,
...
export class UserDeletedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_IS_DELETED) {
    super({
      message,
      statusCode: HTTP_STATUS.FORBIDDEN,
...
export class CannotModifySelfBannedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.CANNOT_MODIFY_SELF_BANNED) {
    super({
      message,
      statusCode: HTTP_STATUS.FORBIDDEN,
...
export class CannotModifyDeletedUserError extends BusinessError {
  constructor(message: string = USER_MESSAGES.CANNOT_MODIFY_DELETED) {
    super({
      message,
...
export class UserAlreadyActiveError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_ALREADY_ACTIVE) {
    super({
      message,
      statusCode: HTTP_STATUS.BAD_REQUEST,
      code: ERROR_CODES.INVALID_INPUT,
...
export class UserAlreadyInactiveError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_ALREADY_INACTIVE) {
    super({
      message,
      statusCode: HTTP_STATUS.BAD_REQUEST,
      code: ERROR_CODES.INVALID_INPUT,
...
export class UserAlreadyBannedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_ALREADY_BANNED) {
    super({
      message,
      statusCode: HTTP_STATUS.BAD_REQUEST,
      code: ERROR_CODES.INVALID_INPUT,
...
export class UserNotBannedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_ALREADY_UNBANNED) {
    super({
      message,
      statusCode: HTTP_STATUS.BAD_REQUEST,
      code: ERROR_CODES.INVALID_INPUT,
...
export class UserAlreadyDeletedError extends BusinessError {
  constructor(message: string = USER_MESSAGES.USER_ALREADY_DELETED) {
    super({
      message,
      statusCode: HTTP_STATUS.BAD_REQUEST,
      code: ERROR_CODES.INVALID_INPUT,
