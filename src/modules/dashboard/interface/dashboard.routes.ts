...
export function createDashboardRoutes(controller: DashboardController): Router {
  ...
  router.get(
    ...
    (req, res, next) => controller.getAdminDashboard(req, res).catch(next)
  );
  ...
  router.get(
    ...
    (req, res, next) => controller.getWorkerDashboard(req, res).catch(next)
  );
  ...
  router.get(
    ...
    (req, res, next) => controller.getClientDashboard(req, res).catch(next)
  );
