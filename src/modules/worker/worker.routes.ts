...
router.get(
  '/public',
  pagination(),
  asyncHandler(workerController.listPublicWorkers.bind(workerController))
);
...
router.get(
  '/:workerId/services',
  pagination(),
  asyncHandler(workerController.listWorkerServices.bind(workerController))
);
...
router.patch(
  ...
  authenticate(),
  authorize(Role.WORKER),
  asyncHandler(workerController.reapply.bind(workerController))
);
