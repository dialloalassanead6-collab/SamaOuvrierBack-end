...
import { reviewRepository, PrismaReviewRepository } from './modules/review/index.js';
...
const reviewController = new ReviewController(createReviewUseCase, getWorkerReviewsUseCase, deleteReviewUseCase);
...
const createPaymentUseCase = new CreatePaymentUseCase(paymentRepository, missionRepository, payTechService, escrowDomainService);
const releaseEscrowUseCase = new ReleaseEscrowUseCase(paymentRepository, missionRepository, payTechService, escrowDomainService, notificationService);
const cancelMissionPaymentUseCase = new CancelMissionPaymentUseCase(paymentRepository, missionRepository, payTechService, escrowDomainService);
const handlePayTechWebhookUseCase = new HandlePayTechWebhookUseCase(paymentRepository, missionRepository, payTechService);
// Create payment controller and routes
const paymentController = new PaymentController(createPaymentUseCase, releaseEscrowUseCase, cancelMissionPaymentUseCase, handlePayTechWebhookUseCase, paymentRepository);
