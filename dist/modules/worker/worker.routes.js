 ...
 */
router.get('/me', authenticate(), authorize(Role.WORKER), asyncHandler(workerController.getMyProfile.bind(workerController)));
/**
 * @swagger
 * /workers/me/missions:
 *   get:
 ...
 *         description: Accès refusé (worker uniquement)
 */
router.get('/me/missions', authenticate(), authorize(Role.WORKER), pagination(), asyncHandler(workerController.getMyMissions.bind(workerController)));
/**
 * @swagger
 * /workers/me/services:
 *   get:
 ...
 *         description: Accès refusé (worker uniquement)
 */
router.get('/me/services', authenticate(), authorize(Role.WORKER), pagination(), asyncHandler(workerController.getMyServices.bind(workerController)));
/**
 * @swagger
 * /workers/me/reapply:
 *   patch:
