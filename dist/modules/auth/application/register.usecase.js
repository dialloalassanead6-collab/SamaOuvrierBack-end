...
export class ProfessionNotFoundError extends RegistrationError {
    constructor() {
        super(AUTH_MESSAGES.PROFESSION_NOT_FOUND, HTTP_STATUS.BAD_REQUEST, ERROR_CODES.PROFESSION_NOT_FOUND);
...
export class NoProfessionAvailableError extends RegistrationError {
    constructor() {
        super(AUTH_MESSAGES.NO_PROFESSION_AVAILABLE, HTTP_STATUS.BAD_REQUEST, ERROR_CODES.NO_PROFESSION);
...
export class EmailAlreadyExistsError extends RegistrationError {
    constructor() {
        super(AUTH_MESSAGES.EMAIL_ALREADY_EXISTS, HTTP_STATUS.CONFLICT, ERROR_CODES.EMAIL_EXISTS);
...
export class AdminRegistrationForbiddenError extends RegistrationError {
    constructor() {
        super(AUTH_MESSAGES.ADMIN_REGISTRATION_FORBIDDEN, HTTP_STATUS.FORBIDDEN, ERROR_CODES.ADMIN_FORBIDDEN);
