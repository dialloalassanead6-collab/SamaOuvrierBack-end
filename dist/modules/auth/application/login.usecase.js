...
export class InvalidCredentialsError extends LoginError {
    constructor() {
        super(AUTH_MESSAGES.INVALID_CREDENTIALS, HTTP_STATUS.UNAUTHORIZED, ERROR_CODES.INVALID_CREDENTIALS);
...
export class WorkerNotApprovedError extends LoginError {
    constructor() {
        super(AUTH_MESSAGES.ACCOUNT_PENDING, HTTP_STATUS.FORBIDDEN, ERROR_CODES.ACCOUNT_PENDING);
...
export class WorkerRejectedError extends LoginError {
    constructor() {
        super(AUTH_MESSAGES.ACCOUNT_REJECTED, HTTP_STATUS.FORBIDDEN, ERROR_CODES.ACCOUNT_REJECTED);
...
export class UserBannedLoginError extends LoginError {
    constructor() {
        super(AUTH_MESSAGES.ACCOUNT_BANNED, HTTP_STATUS.FORBIDDEN, ERROR_CODES.USER_BANNED);
...
export class UserDeletedLoginError extends LoginError {
    constructor() {
        super(AUTH_MESSAGES.ACCOUNT_DELETED, HTTP_STATUS.FORBIDDEN, ERROR_CODES.USER_DELETED);
