...
export class DashboardController {
    ...
    constructor(getAdminDashboardUseCase, getWorkerDashboardUseCase, getClientDashboardUseCase) {
        this.getAdminDashboardUseCase = getAdminDashboardUseCase;
        this.getWorkerDashboardUseCase = getWorkerDashboardUseCase;
        this.getClientDashboardUseCase = getClientDashboardUseCase;
    }
    /**
