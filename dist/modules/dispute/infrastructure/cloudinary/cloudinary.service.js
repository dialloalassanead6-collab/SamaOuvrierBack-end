...
export class CloudinaryService {
     ...
     */
    async uploadEvidence(file, disputeId, uploadedBy) {
        // Validate file first
     ...
     */
    async deleteDisputeEvidence(disputeId) {
        try {
     ...
     */
    async verifyFileOwnership(publicId, disputeId) {
        try {
