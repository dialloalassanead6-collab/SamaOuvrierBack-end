...
export function createReviewRoutes(controller) {
     ...
     */
    router.post('/', validateRequest(createReviewSchema, 'body'), controller.createReview.bind(controller));
    /**
     * GET /api/workers/:workerId/reviews
     * Get all reviews for a worker
     * Public endpoint
     */
    router.get('/workers/:workerId/reviews', validateRequest(getWorkerReviewsSchema, 'params'), controller.getWorkerReviews.bind(controller));
    /**
     * DELETE /api/reviews/:id
     * Delete a review (admin only)
     * Protected: Admin only
     */
    router.delete('/:id', authorize(Role.ADMIN), validateRequest(deleteReviewSchema, 'params'), controller.deleteReview.bind(controller));
    return router;
}
